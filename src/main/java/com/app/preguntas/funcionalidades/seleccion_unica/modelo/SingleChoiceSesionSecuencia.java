...
public class SeleccionUnicaSesionSecuencia implements Serializable {

    private final List<Long> questionIds = new ArrayList<>();
    private final Map<Long, Integer> answers = new HashMap<>();
    private int currentIndex = 0;

    public SeleccionUnicaSesionSecuencia() {
    }

    public SeleccionUnicaSesionSecuencia(List<Long> ids) {
        if (ids != null) {

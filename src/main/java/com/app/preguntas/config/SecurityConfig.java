...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(RepositorioUsuarioApp userRepository) {
        return username -> {
            UsuarioApp UsuarioApp = userRepository.findByUsername(username)
                    .orElseThrow(() -> new UsernameNotFoundException("Usuario no encontrado: " + username));
            return User.builder()
                    .username(UsuarioApp.getUsername())
                    .password(UsuarioApp.getPassword())
                    .roles(UsuarioApp.getRole())
                    .build();
        };
    }

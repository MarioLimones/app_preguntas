...
public class AuthApiController {
    ...
    public AuthApiController(AppUserService userService, PasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<Map<String, Object>> login(@RequestBody Map<String, String> credentials) {
        ...
        Optional<AppUser> optUser = userService.findByUsername(username);
    ...
    public ResponseEntity<Map<String, Object>> register(@RequestBody Map<String, String> data) {
        ...
        AppUser newUser = new AppUser(username, password, "USER");

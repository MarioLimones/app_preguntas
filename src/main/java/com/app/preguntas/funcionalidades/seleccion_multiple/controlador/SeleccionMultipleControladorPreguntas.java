...
import com.app.preguntas.funcionalidades.seleccion_multiple.modelo.SeleccionMultipleFormularioPregunta;
...
@Controller
@RequestMapping("/mc/preguntas")
public class SeleccionMultipleControladorPreguntas {

    private final SeleccionMultipleServicioPreguntas service;

    public SeleccionMultipleControladorPreguntas(SeleccionMultipleServicioPreguntas service) {
    ...
    public String createForm(Model model) {
        model.addAttribute("form", new SeleccionMultipleFormularioPregunta());
        model.addAttribute("mode", "create");
        return "seleccion_multiple/formulario";
    }

    @PostMapping
    public String create(@Valid @ModelAttribute("form") SeleccionMultipleFormularioPregunta form,
        ...
        PreguntaSeleccionMultiple created = service.create(toQuestion(form, options, correctIndexes));
        redirectAttributes.addFlashAttribute("success", "Pregunta creada.");
        return "redirect:/mc/preguntas/" + created.getId();
    }

    @GetMapping("/{id}")
    public String detail(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes) {
        Optional<PreguntaSeleccionMultiple> question = service.findById(id);
        if (question.isEmpty()) {
    ...
    public String editForm(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes) {
        ...
        SeleccionMultipleFormularioPregunta form = fromQuestion(question.get());
    ...
    public String update(@PathVariable Long id,
            @Valid @ModelAttribute("form") SeleccionMultipleFormularioPregunta form,
            BindingResult bindingResult,
            RedirectAttributes redirectAttributes,
            Model model) {
        List<String> options = validateAndParseOptions(form, bindingResult);
        ...
        Optional<PreguntaSeleccionMultiple> updated = service.update(id, toQuestion(form, options, correctIndexes));
        if (updated.isEmpty()) {
            redirectAttributes.addFlashAttribute("error", "La pregunta no existe.");
            return "redirect:/mc/preguntas";
        }
        redirectAttributes.addFlashAttribute("success", "Pregunta actualizada.");
        return "redirect:/mc/preguntas/" + id;
    }
    ...
    private PreguntaSeleccionMultiple toQuestion(SeleccionMultipleFormularioPregunta form,
            List<String> options,
            List<Integer> correctIndexes) {
        PreguntaSeleccionMultiple question = new PreguntaSeleccionMultiple();
    ...
    private SeleccionMultipleFormularioPregunta fromQuestion(PreguntaSeleccionMultiple question) {
        SeleccionMultipleFormularioPregunta form = new SeleccionMultipleFormularioPregunta();

    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {quizzes.map((quiz) => (
                    <div key={quiz.id} className="group relative bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-300 transform hover:-translate-y-1">
                        <div className={`inline-flex items-center justify-center p-4 rounded-2xl ${quiz.bg} ${quiz.color} mb-6 transition-transform group-hover:scale-110`}>
                        ...
                        <Link
                            to={quiz.path}
                            className={`flex items-center justify-between w-full px-6 py-4 rounded-2xl font-bold text-sm transition-all ${quiz.bg} ${quiz.color} hover:brightness-95`}
                        >

...
public class MultipleChoiceSequenceSession implements Serializable {

    private final List<Long> questionIds = new ArrayList<>();
    private final Map<Long, List<Integer>> answers = new HashMap<>();
    private int currentIndex = 0;

    public MultipleChoiceSequenceSession() {
    }

    public MultipleChoiceSequenceSession(List<Long> ids) {
        if (ids != null) {

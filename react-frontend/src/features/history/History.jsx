                        ...
                        <div key={result.id} className="group bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-50 transition-all duration-300">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                <div className="flex items-center gap-5">
                                    <div className={`shrink-0 w-14 h-14 rounded-2xl flex items-center justify-center font-black text-xs ${result.quizType === 'VF' ? 'bg-emerald-50 text-emerald-600' :
                                            result.quizType === 'SC' ? 'bg-sky-50 text-sky-600' :
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-sm font-bold text-gray-900">
                                                {result.quizType === 'VF' ? 'Verdadero o Falso' : result.quizType === 'SC' ? 'Selección Única' : 'Selección Múltiple'}
                                            </span>
